...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    axios
      .get(
        " https://causal-jawfish-immune.ngrok-free.app/v1/api/return-notes/revenue-warehouse/monthly",
      )
      .then((response) => {
    ...
    axios
      .get(" https://causal-jawfish-immune.ngrok-free.app/v1/api/products/count")
      .then((response) => {
    ...
    axios
      .get(" https://causal-jawfish-immune.ngrok-free.app/v1/api/receipts/summary")
      .then((response) => {
    ...
    axios
      .get(" https://causal-jawfish-immune.ngrok-free.app/v1/api/employees")
      .then((response) => {
    ...
    axios
      .get(" https://causal-jawfish-immune.ngrok-free.app/v1/api/customers")
      .then((response) => {
    ...
    axios
      .get(" https://causal-jawfish-immune.ngrok-free.app/v1/api/suppliers")
      .then((response) => {
    ...
    axios
      .get(
        " https://causal-jawfish-immune.ngrok-free.app/v1/api/deliveryNotes/delivery-summary?type=2&status=1",
      )
      .then((response) => {
    ...
    axios
      .get(
        " https://causal-jawfish-immune.ngrok-free.app/v1/api/deliveryNotes/delivery-summary?type=1&status=1",
      )
      .then((response) => {
        if (response.data.success) {
          console.log("data: ", response.data.data);
      ...
      axios
      .get(
        " https://causal-jawfish-immune.ngrok-free.app/v1/api/deliveryNotes/delivery-summary?type=3&status=2",
      )
      .then((response) => {
        if (response.data.success) {

...
const WarehouseManagement: React.FC = () => {
  ...
  useEffect(() => {
    const fetchWarehouses = async () => {
      try {
        const response = await axiosInstance.get(" https://causal-jawfish-immune.ngrok-free.app/v1/api/warehouses");
  ...
  const handleFormSubmit = async (formData: Warehouse) => {
    try {
      if (editingWarehouse) {
        await axiosInstance.put(` https://causal-jawfish-immune.ngrok-free.app/v1/api/warehouses/${editingWarehouse.id}`, formData);
        ...
        const response = await axiosInstance.post(" https://causal-jawfish-immune.ngrok-free.app/v1/api/warehouses", formData);
  ...
  const deleteWarehouse = async (warehouseId: number) => {
    try {
      await axiosInstance.delete(` https://causal-jawfish-immune.ngrok-free.app/v1/api/warehouses/${warehouseId}`);
